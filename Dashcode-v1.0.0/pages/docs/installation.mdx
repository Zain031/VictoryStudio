...
Before you start installing Dashcode, make sure you have a folder ready where you can open the downloaded `.zip` file.
...
This `.zip` file has the Starter version inside, which has all the main parts and features of Dashcode, but without the Demo apps, pages, and UI sections. Use the Starter version to build your app on top.
