export const basicDialog=`import { Button } from "@/components/ui/button";
import {
  Dialog,
  DialogClose,
  DialogContent,
...
export const sizesDialog=`import { Button } from "@/components/ui/button";
import {
  Dialog,
  DialogClose,
  DialogContent,
  ...
  return (
    <div className="flex flex-wrap gap-3">
      <Dialog>
        ...
        <DialogContent
          closeIconClass="text-primary-foreground"
        >
          <DialogHeader className="bg-primary">
            <DialogTitle className="text-primary-foreground">Default Dialog</DialogTitle>
          </DialogHeader>
          <DialogDescription className="pb-8">
            <h3 className="text-base font-medium text-default-950 my-2 mt-3">Buy me a coffe.</h3>
            <p className="text-base text-default-500 mt-2">We  enables fans to financially support their favorite creators through donations.</p>
      ...
      <Dialog>
        ...
        >
          <DialogHeader className="bg-primary">
            <DialogTitle className="text-primary-foreground">Large Dialog</DialogTitle>
          </DialogHeader>
          <DialogDescription className="pb-8">
            <h3 className="text-base font-medium text-default-950 my-2 mt-3">Buy me a coffe.</h3>
            <p className="text-base text-default-500 mt-2">We  enables fans to financially support their favorite creators through donations.</p>
      ...
      <Dialog>
        ...
        >
          <DialogHeader className="bg-primary">
            <DialogTitle className="text-primary-foreground">Medium Dialog</DialogTitle>
          </DialogHeader>
          <DialogDescription className="pb-8">
            <h3 className="text-base font-medium text-default-950 my-2 mt-3">Buy me a coffe.</h3>
            <p className="text-base text-default-500 mt-2">We  enables fans to financially support their favorite creators through donations.</p>
      ...
      <Dialog>
        ...
        >
          <DialogHeader className="bg-primary">
            <DialogTitle className="text-primary-foreground">Small Dialog</DialogTitle>
          </DialogHeader>
          <DialogDescription className="pb-8">
            <h3 className="text-base font-medium text-default-950 my-2 mt-3">Buy me a coffe.</h3>
            <p className="text-base text-default-500 mt-2">We  enables fans to financially support their favorite creators through donations.</p>
